package base.app.agvmanager.console.Http;

import base.app.agvmanager.console.AgvManagerServer;
import base.app.agvmanager.console.Sensor;
...
public class HttpAjaxVotingRequest extends Thread {
	...
	public HttpAjaxVotingRequest(Socket s, String f, Sensor sensor) {
		baseFolder=f; sock=s;
		this.sensor=sensor;
		}	
        	...
        	try {
        		...
        		if(request.getMethod().equals("GET")) {
					...
					response.setContentFromString(
						AgvManagerServer.getVotesStandingInHTML(sensor), "text/html");
